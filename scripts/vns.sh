...
# Shortcut: If an interface argument is passed directly
# Example: ./vns.sh tun1
...
echo " 4) TUN1 (Secondary OpenVPN Policy Tunnel)"
echo " 5) ALL  (Global Summary / System-wide)"
echo " q) Exit Tool"
echo "=================================================================="

echo -n "Select target interface [1-5 or q]: "
